class Dados {
    ...
    gerarRelatorio() {
        ...
        this.viagensTotais.forEach((viagem, index) => {
            ...
            html += "Custo com caminhões de PEQUENO PORTE: " + dadosRelatorio.custoPorModadelidade.pequeno.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' }) + " <br> "
            html += "Quantidade de caminhões de MÉDIO PORTE: " + dadosRelatorio.trucks.medio + "<br>"
            html += "Custo com caminhões de MÉDIO PORTE: " + dadosRelatorio.custoPorModadelidade.medio.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' }) + " <br> "
            html += "Quantidade de caminhões de GRANDE PORTE: " + dadosRelatorio.trucks.grande + "<br>"
            html += "Custo com caminhões de GRANDE PORTE: " + dadosRelatorio.custoPorModadelidade.grande.toLocaleString('pt-br', { style: 'currency', currency: 'BRL' }) + " <br> "
